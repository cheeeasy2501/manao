                ...
                <form id="login-form">
                    <div>
                        ...
                        <input type="text"
                               ...
                               data-validation-error-msg-length = "Логин должен состоять минимум из 5 символов"
                        >
                    </div>
                    <div>
                        ...
                        <input type="password" name="password"
                               ...
                               data-validation-error-msg-length = "Пароль должен состоять минимум из 6 символов"
                        >
                    </div>
            ...
            <form id="registration-form">
                <div>
                    ...
                    <input type="email"
                           ...
                           data-validation-error-msg-email = "Введите корректный Email-адрес"
                    >
                </div>
                <div>
                    ...
                    <input type="text"
                           ...
                           data-validation-error-msg-length = "Обязательное поле"
                    >
                </div>
                <div>
                    <div class="input-name">Введите логин</div>
                ...
                <div>
                    ...
                    <input type="password"
                           ...
                           data-validation-error-msg = "Введенный пароль не совпадает!"
                    >
                </div>
